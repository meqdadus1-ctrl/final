...
<head>
    ...
    <style>
        ...
        .sidebar { width: 250px; height: 100vh; background: #1e3a5f; position: fixed; right: 0; top: 0; overflow-y: auto; overflow-x: hidden; }
        ...
        .topbar { background: #fff; padding: 12px 20px; border-radius: 10px; margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 1px 4px rgba(0,0,0,0.08); }
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            <a href="{{ route('salary.index') }}" class="nav-link {{ request()->routeIs('salaries.*') ? 'active' : '' }}">
