<x-app-layout>
    <x-slot name="title">إضافة حدث جديد</x-slot>

    <div class="card shadow-sm" style="max-width:700px; margin: 0 auto;">
        <div class="card-header">
            <i class="fas fa-calendar-plus me-2"></i> إضافة حدث جديد
        </div>
        <div class="card-body">
            <form action="{{ route('events.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="title"
                               ...
                               value="{{ old('title') }}" required placeholder="عنوان الحدث...">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" rows="3"
                                  ...
                                  placeholder="تفاصيل الحدث (اختياري)">{{ old('description') }}</textarea>
                    ...
                    <div class="col-md-6 d-flex align-items-end">
                        <div class="form-check mb-1">
                            <input class="form-check-input" type="checkbox" name="all_day" value="1"
                                   id="all_day" {{ old('all_day') ? 'checked' : '' }}>
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-1"></i> حفظ الحدث
                    </button>
